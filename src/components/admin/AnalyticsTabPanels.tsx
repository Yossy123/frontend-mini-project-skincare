...
type Props = {
  ...
  ordersData: OrderAnalyticsResponse | null;
  productsData: ProductAnalyticsResponse | null;
  customersData: CustomerAnalyticsResponse | null;
  paymentsData: PaymentAnalyticsResponse | null;
  shippingData: ShippingAnalyticsResponse | null;
};
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800">
              ...
              <div className="text-[10px] text-zinc-500 mt-1">Revenue Ã· Paid Orders</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            <div className="p-6 rounded-3xl bg-zinc-900/90 border border-zinc-800">
              ...
              <div className="text-[10px] text-zinc-500 mt-1">
                {customersData.summary.repeat_customers} customers placed â‰¥ 2 orders
              </div>
            </div>
          </div>
