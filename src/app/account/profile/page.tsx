...
export default function AccountProfilePage() {
  ...
  if (!isAuthHydrated || (!user && loading)) {
    return <div className="flex min-h-screen flex-col bg-transparent"><Navbar /><main className="mx-auto flex-1 px-4 py-16 text-sm text-zinc-500">Memuat profil...</main><Footer /></div>;
  }
